...
def build_staffing_provider_metrics():
...
def build_state_metrics():
    ...
    return state_healthcare_metrics_df


def build_vaccination_metrics():
    ...
    return vaccination_comparison_df
...
def main() -> None:
    ...
    if gold_domain == "STAFFING_PROVIDER":
        ...
        (
            ...
            nursing_hours_patient_hospital_ratio_df,
            permanent_contract_ratio_df
        ) = build_staffing_provider_metrics()
        ...
        validate_unique(
            nursing_hours_patient_hospital_ratio_df,
            ["provider_id", "work_date"],
            "avg_nurse_hours_to_patient_hospital"
        )
    ...
    elif gold_domain == "STATE_METRICS":
    ...
    elif gold_domain == "VACCINATION":

        vaccination_comparison_df = (
            build_vaccination_metrics()
        )
